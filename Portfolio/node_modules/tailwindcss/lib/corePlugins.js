...
const _createUtilityPlugin = /*#__PURE__*/ _interop_require_default(require("tailwindcss/lib/util/createUtilityPlugin"));
const _buildMediaQuery = /*#__PURE__*/ _interop_require_default(require("tailwindcss/lib/util/buildMediaQuery"));
const _escapeClassName = /*#__PURE__*/ _interop_require_default(require("tailwindcss/lib/util/escapeClassName"));
const _parseAnimationValue = /*#__PURE__*/ _interop_require_default(require("tailwindcss/lib/util/parseAnimationValue"));
const _flattenColorPalette = /*#__PURE__*/ _interop_require_default(require("tailwindcss/lib/util/flattenColorPalette"));
const _withAlphaVariable = /*#__PURE__*/ _interop_require_wildcard(require("tailwindcss/lib/util/withAlphaVariable"));
const _toColorValue = /*#__PURE__*/ _interop_require_default(require("tailwindcss/lib/util/toColorValue"));
const _isPlainObject = /*#__PURE__*/ _interop_require_default(require("tailwindcss/lib/util/isPlainObject"));
const _transformThemeValue = /*#__PURE__*/ _interop_require_default(require("tailwindcss/lib/util/transformThemeValue"));
const _packagejson = require("tailwindcss/package.json");
const _log = /*#__PURE__*/ _interop_require_default(require("tailwindcss/lib/util/log"));
const _normalizeScreens = require("tailwindcss/lib/util/normalizeScreens");
const _parseBoxShadowValue = require("tailwindcss/lib/util/parseBoxShadowValue");
const _removeAlphaVariables = require("tailwindcss/lib/util/removeAlphaVariables");
const _featureFlags = require("tailwindcss/lib/featureFlags");
const _dataTypes = require("tailwindcss/lib/util/dataTypes");
const _setupContextUtils = require("tailwindcss/lib/lib/setupContextUtils");
...
let variantPlugins = {
    ...
    screenVariants: ({ theme , addVariant , matchVariant  })=>{
        ...
        /**
     * @typedef {import('tailwindcss/lib/util/normalizeScreens').Screen} Screen
     */ /**
     * @param {'min' | 'max'} type
