...
const _cloneNodes = /*#__PURE__*/ _interop_require_default(require("tailwindcss/lib/util/cloneNodes"));
const _defaultExtractor = require("tailwindcss/lib/lib/defaultExtractor");
...
/**
 *
 * @param {[import('tailwindcss/lib/lib/offsets.js').RuleOffset, import('postcss').Node][]} rules
 * @param {*} context
