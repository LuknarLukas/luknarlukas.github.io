...
const _parseObjectStyles = /*#__PURE__*/ _interop_require_default(require("tailwindcss/lib/util/parseObjectStyles"));
const _prefixSelector = /*#__PURE__*/ _interop_require_default(require("tailwindcss/lib/util/prefixSelector"));
...
const _nameClass = /*#__PURE__*/ _interop_require_wildcard(require("tailwindcss/lib/util/nameClass"));
const _pluginUtils = require("tailwindcss/lib/util/pluginUtils");
const _corePlugins = require("tailwindcss/lib/corePlugins");
const _sharedState = /*#__PURE__*/ _interop_require_wildcard(require("tailwindcss/lib/lib/sharedState"));
const _toPath = require("tailwindcss/lib/util/toPath");
const _log = /*#__PURE__*/ _interop_require_default(require("tailwindcss/lib/util/log"));
const _negateValue = /*#__PURE__*/ _interop_require_default(require("tailwindcss/lib/util/negateValue"));
const _isSyntacticallyValidPropertyValue = /*#__PURE__*/ _interop_require_default(require("tailwindcss/lib/util/isSyntacticallyValidPropertyValue"));
const _generateRules = require("tailwindcss/lib/lib/generateRules");
const _cacheInvalidation = require("tailwindcss/lib/lib/cacheInvalidation.js");
const _offsets = require("tailwindcss/lib/lib/offsets.js");
const _featureFlags = require("tailwindcss/lib/featureFlags.js");
const _formatVariantSelector = require("tailwindcss/lib/util/formatVariantSelector");
